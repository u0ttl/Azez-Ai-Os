...
const checks = [
  [
    "phone composition is width bounded and does not hijack touch laptops",
  ...
  ["readability and accessibility quality gate is installed", css.includes("/* AZEZ_INTERFACE_QUALITY_V2 */") && css.includes("@media (prefers-reduced-motion:reduce)")],
