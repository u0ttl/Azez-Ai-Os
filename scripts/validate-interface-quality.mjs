...
const checks = [
  ...
  ["six mobile navigation items fit without edge clipping", css.includes("flex:0 0 calc((100% - 20px)/6)!important") && css.includes("min-width:44px!important") && css.includes("justify-content:space-between!important")],
